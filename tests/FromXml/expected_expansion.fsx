        ...
        type TestFields with
            static member FromXmlNode (xml : System.Xml.XmlNode) =
                ...
                ({
                    ...
                    ``SimpleUnion`` = (exactlyOne fromTagsOrAttributes xml "SimpleUnion" (parserForSimpleUnion "Amazingant.FSharp.TypeExpansion.Templates.FromXml.Tests.SumType" "Amazingant.FSharp.TypeExpansion.Templates.FromXml.Tests.TestFields.SimpleUnion"));
                    ``MaybeUnion`` = (maybeOne fromTagsOrAttributes xml "MaybeUnion" (parserForSimpleUnion "Amazingant.FSharp.TypeExpansion.Templates.FromXml.Tests.SumType" "Amazingant.FSharp.TypeExpansion.Templates.FromXml.Tests.TestFields.MaybeUnion"));
                    ``UnionList`` = (getList fromTagsOrAttributes xml "UnionList" (parserForSimpleUnion "Amazingant.FSharp.TypeExpansion.Templates.FromXml.Tests.SumType" "Amazingant.FSharp.TypeExpansion.Templates.FromXml.Tests.TestFields.UnionList"));
                    ``UnionArray`` = (getArray fromTagsOrAttributes xml "UnionArray" (parserForSimpleUnion "Amazingant.FSharp.TypeExpansion.Templates.FromXml.Tests.SumType" "Amazingant.FSharp.TypeExpansion.Templates.FromXml.Tests.TestFields.UnionArray"));
                    ``UnionSeq`` = (getSeq fromTagsOrAttributes xml "UnionSeq" (parserForSimpleUnion "Amazingant.FSharp.TypeExpansion.Templates.FromXml.Tests.SumType" "Amazingant.FSharp.TypeExpansion.Templates.FromXml.Tests.TestFields.UnionSeq"));
                    ``MaybeUnionList`` = (getMaybeList fromTagsOrAttributes xml "MaybeUnionList" (parserForSimpleUnion "Amazingant.FSharp.TypeExpansion.Templates.FromXml.Tests.SumType" "Amazingant.FSharp.TypeExpansion.Templates.FromXml.Tests.TestFields.MaybeUnionList"));
                    ``MaybeUnionArray`` = (getMaybeArray fromTagsOrAttributes xml "MaybeUnionArray" (parserForSimpleUnion "Amazingant.FSharp.TypeExpansion.Templates.FromXml.Tests.SumType" "Amazingant.FSharp.TypeExpansion.Templates.FromXml.Tests.TestFields.MaybeUnionArray"));
                    ``MaybeUnionSeq`` = (getMaybeSeq fromTagsOrAttributes xml "MaybeUnionSeq" (parserForSimpleUnion "Amazingant.FSharp.TypeExpansion.Templates.FromXml.Tests.SumType" "Amazingant.FSharp.TypeExpansion.Templates.FromXml.Tests.TestFields.MaybeUnionSeq"));
